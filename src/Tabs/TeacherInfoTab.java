...
public class TeacherInfoTab extends Tab{
	   ...
	   public TeacherInfoTab()
	   {
		  ...
		  GridPane  gp = new GridPane();
			...
			//Inputs
		  	...
		  	t6.setPromptText("Degree");

		  	b1 = new Button("Add Teacher");
		  	b2 = new Button("List Teacher");
			...
			//button actions
			b1.setOnAction( e -> AddTeacher(t1, t2, t3, t4, t5, t6, t5.getText()));
	...
	private boolean AddTeacher(TextField input,TextField input2,TextField input3,TextField input4,TextField input5,TextField input6, String message){
		try{
			...
			Tlc.addTeacherToList(Fname,Mname, Sname, email, tnum, dob);
